...
function [ FD ] = AircraftParameters(x_cg, mass)
...
FD.Inertia.Ixx = 5066*(2650/2087)*(9.11/10.19)^1;   % Aircraft Moments of Inertia (kg.m^2)
FD.Inertia.Iyy = 6578*(2650/2087)*(11.23/10.18)^1;  % Aircraft Moments of Inertia (kg.m^2)
FD.Inertia.Izz = 10975*(2650/2087)*(3.75/3.26)^1;   % Aircraft Moments of Inertia (kg.m^2)
FD.Inertia.Ixz = 203*(2650/2087);                   % Aircraft Product of Inertia (kg.m^2)
